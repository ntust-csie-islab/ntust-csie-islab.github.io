...
**      ftp://ftp.rz.uni-karlsruhe.de/pub/net/www/tools/giftrans.os2.exe
...
char copyright[] = "@(#)(c) Copyright 1994 by Andreas Ley (ley@rz.uni-karlsruhe.de)";
char sccsid[] = "@(#)GIFtrans v1.12 - Transpose GIF files";
